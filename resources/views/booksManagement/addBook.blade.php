...
@section('content')
    <form class="{{ route('postbook') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="  my-16 mx-20 space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-4">
                        <label for="category" class="block text-sm font-medium leading-6 text-gray-900">Book
                            category</label>
                        <div class="mt-2 ">
                            <div class="  text-gray-300 rounded-md">
                                <!--Select large-->
                                <select name="category" id="category" class=" rounded-md  border-gray-300"
                                    ...
                                    <option value="telnologi">Teknologi</option>
                                </select>
                            </div>
                    ...
                    <div class="col-span-full">
                        <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">Book
                            Cover</label>
