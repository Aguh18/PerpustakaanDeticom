...
@section('content')
    <section class="flex w-full h-screen ">
        ...
        {{-- sidebar section --}}
        <div class="flex-col w-56 h-full px-6 overflow-y-auto bg-gray-900 shrink-0 grow gap-y-5">
            ...
            <nav class="flex flex-col flex-1">
                <ul role="list" class="flex flex-col flex-1 gap-y-7">
                    ...
                    <li class="mt-auto -mx-6">
                        <a href="#"
                            class="flex items-center px-6 py-3 text-sm font-semibold leading-6 text-white gap-x-4 hover:bg-gray-800">
        ...
        {{-- end sidebar section --}}
        {{-- main bar section --}}
        <section class="flex-auto w-5/6 ">
            <div class="flex flex-col h-full bg-red-300 ">
                <div class="flex items-center w-full h-20 pl-10 bg-blue-500">hallo {{ Auth::user()->name }} </div>
                {{-- main setion --}}
                <div class="flex w-full h-16 bg-yellow-100 ">
                    <div class="flex-auto w-1/2 px-10 bg-teal-200 ">
                        <a href="{{ route('addbook') }}"> ini tombol tambah</a>
                    </div>
                    <div class="flex-auto w-1/2 bg-teal-400 "> kanan</div>
                </div>
                {{-- book --}}
                <div class="h-full px-20 overflow-scroll bg-green-200 ">

                    @foreach ($books as $book)
                        <div class="flex h-16 mb-6 border border-black ">
                            <div class="flex-1 bg-purple-400 border-black border-right">
                                <img class="h-20 " src="{{ asset('storage/covers/' . $book->cover) }}" alt="">
                            </div>

                            <div class="flex-1 bg-red-50">{{ $book->title }}</div>
                            <div class="flex flex-col items-center justify-center flex-1 mx-auto my-auto bg-yellow-300 ">
                                <div>
                                ...
                                <div>
                                    <a href="{{ route('book.edit.view', $book->id) }}">Edit</a>
                                </div>
